...
- (void)setAdTitleArray:(NSArray *)adTitleArray withShowStyle:(AdTitleShowStyle)adTitleStyle 
{
    ...
    _centerAdLabel.frame = CGRectMake(0, kAdViewHeight - 30, kAdViewWidth-40, 30);
...
- (void)setPageControlShowStyle:(UIPageControlShowStyle)PageControlShowStyle
{
    ...
    else if (PageControlShowStyle == UIPageControlShowStyleTop)
    {
        _pageControl.frame = CGRectMake(0, 0, 20*_pageControl.numberOfPages, 20);
        _pageControl.center = CGPointMake(kAdViewWidth/2.0, 50);
    }
    else
    {
        _pageControl.frame = CGRectMake( kAdViewWidth - 20*_pageControl.numberOfPages - 8, kAdViewHeight-24, 20*_pageControl.numberOfPages, 20);
    }
...
-(void)tap
{
    if ([self.adViewDelegate respondsToSelector:@selector(clickAdView)]) {
        [self.adViewDelegate clickAdView];
    }
    if (_callBack) {
