...
- (void)_setupSubviews
{
    ...
    [styleChangeButton setImage:[UIImage imageNamed:@"chat_btn_voice"] forState:UIControlStateNormal];
    [styleChangeButton setImage:[UIImage imageNamed:@"chat_btn_keyboard"] forState:UIControlStateSelected];
    ...
    [self.faceButton setImage:[UIImage imageNamed:@"chat_btn_expression"] forState:UIControlStateNormal];
    [self.faceButton setImage:[UIImage imageNamed:@"chat_btn_expression"] forState:UIControlStateHighlighted];
    [self.faceButton setImage:[UIImage imageNamed:@"chat_btn_keyboard"] forState:UIControlStateSelected];
    ...
    [self.moreButton setImage:[UIImage imageNamed:@"chat_btn_camera"] forState:UIControlStateNormal];
    [self.moreButton setImage:[UIImage imageNamed:@"chat_btn_camera"] forState:UIControlStateHighlighted];
...
{
    if ([self.delegate respondsToSelector:@selector(didSelectImageAction)]) {
        [self.delegate didSelectImageAction];
        return;
    }
